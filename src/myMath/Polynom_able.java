...
public interface Polynom_able extends cont_function{
	 ...
	 * @param p1
	 */
	public void substract(Polynom_able p1);// איך אני אחסר אם אין לי גישה למקדם של איקס אני לא אוכל לעדכן את הערך שלו
	/**
	 * Multiply this Polynom by p1
	 * @param p1
	 */
	public void multiply(Polynom_able p1);//בעיקר בעיה של כינוס איברים
	/**
